...
===============Business Hour resourceThis provides access to the business hour resources
...
-------
###allmixed Freshdesk\Resources\BusinessHour::all(array|null $query)Get a list of all agents.
...
###viewarray|null Freshdesk\Resources\BusinessHour::view(integer $id, array|null $query)View a resource
